...
#+begin_src yaml
  nextcloud-app:
    ...
    volumes:
      ...
      - /srv/zmedia/music:/var/www/html/data/artem/files/music
      - /srv/zmedia/pictures:/var/www/html/data/artem/files/pictures
      - type: tmpfs
        target: /tmp:exec
    environment:
      # app
...
#+begin_src yaml
  navidrome:
    ...
    volumes:
      ...
      - /srv/zmedia/music:/music:ro
      - /srv/zmedia/playlists:/playlists
    environment:
      # proxy
